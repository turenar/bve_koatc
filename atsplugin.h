...
// ATS Keys
#define ATS_KEY_S	0	// S (Space)
#define ATS_KEY_A1	1	// A1 (Insert)
#define ATS_KEY_A2	2	// A2 (Delete)
#define ATS_KEY_B1	3	// B1 (Home)
#define ATS_KEY_B2	4	// B2 (End)
#define ATS_KEY_C1	5	// C1 (PageUp) 
#define ATS_KEY_C2	6	// C2 (PageDown)
#define ATS_KEY_D	7	// D (D2)
#define ATS_KEY_E	8	// R (D3)
#define ATS_KEY_F	9	// F (D4)
#define ATS_KEY_G	10	// G (D5)
#define ATS_KEY_H	11	// H (D6)
#define ATS_KEY_I	12	// I (D7)
#define ATS_KEY_J	13	// J (D8)
#define ATS_KEY_K	14	// K (D9)
#define ATS_KEY_L	15	// L (D10)
